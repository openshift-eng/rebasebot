...
if [ -f DOWNSTREAM_OWNERS ]; then
    ...
    def _setup_github_provider(fake_github_provider):
        ...
        fake_github_provider.github_app.get_repo = fake_get_repo
        fake_github_provider.github_cloner_app.get_repo = fake_get_repo
    ...
    def test_pr_body_on_create(
        ...
        dest_repo = fake_github_provider.github_app.get_repo(dest.full_name)
        dest_repo.create_pull.return_value = MagicMock(html_url="https://github.com/dest/dest/pull/1")
        ...
        assert result
        body = dest_repo.create_pull.call_args.kwargs["body"]
        assert body
    ...
    def test_pr_body_on_update(
        ...
        pull_req.edit.return_value = True
        ...
        assert result
        body_updates = [call for call in pull_req.edit.call_args_list if "body" in call.kwargs]
