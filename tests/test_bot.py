...
from rebasebot.bot import _add_to_rebase, _is_pr_available, _report_result, _update_pr_title
...
class TestIsPrAvailable:
    ...
    def test_is_pr_available(self, dest_repo, dest, rebase):
        ...
        dest_repo.pull_requests.assert_called_once_with(base="dest-branch")
        assert pr == gh_pr
    ...
    def test_is_pr_available_not_found(self, dest_repo, dest, rebase):
        ...
        pr, pr_available = _is_pr_available(dest_repo, dest, rebase)
        dest_repo.pull_requests.assert_called_with(base="dest-branch")
        assert pr is None
